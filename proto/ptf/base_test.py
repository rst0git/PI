...
class TestIPv4ToBinary(unittest.TestCase):
    def test_valid_ipv4(self):
        ...
        self.assertEqual(ipv4_to_binary('0.0.0.0'), '\x00\x00\x00\x00')
        self.assertEqual(ipv4_to_binary('192.168.0.1'), '\xc0\xa8\x00\x01')
        self.assertEqual(ipv4_to_binary('255.255.255.255'), '\xff\xff\xff\xff')
...
class TestMacToBinary(unittest.TestCase):
    def test_valid_mac(self):
        ...
        self.assertEqual(mac_to_binary('00:00:00:00:00:00'), '\x00\x00\x00\x00\x00\x00')
        self.assertEqual(mac_to_binary('00:de:ad:be:ef:ff'), '\x00\xde\xad\xbe\xef\xff')
        self.assertEqual(mac_to_binary('a0:b1:c2:d3:e4:f5'), '\xa0\xb1\xc2\xd3\xe4\xf5')
